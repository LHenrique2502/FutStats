export const blogPosts = [
  {
    ...
    excerpt: "Confira as nossas recomendações de apostas para o dia 15 de janeiro de 2026.",
    content: "Olá a todos! Hoje é mais um dia de apostas e aqui no FutStats, estamos aqui para ajudá-lo a tomar as melhores decisões. Lembre-se de que apostar envolve risco e é importante fazer isso de forma responsável.\n\nAqui estão as nossas recomendações de apostas para o dia 15 de janeiro de 2026:\n\n**Top Matches**\n\n* Pouso Alegre x Itabirito (Campeonato Mineiro) - 100% chance de mais de 2,5 gols e 100% chance de empate/vitória de ambos os times.\n* Tombense x Cruzeiro (Campeonato Mineiro) - 70% chance de mais de 2,5 gols e 80% chance de empate/vitória de ambos os times.\n* Bangu x Flamengo (Campeonato Carioca) - 80% chance de mais de 2,5 gols e 80% chance de empate/vitória de ambos os times.\n* Bragantino x Corinthians (Campeonato Paulista) - 60% chance de mais de 2,5 gols e 40% chance de empate/vitória de ambos os times.\n* Hellas Verona x Bologna (Serie A) - 60% chance de mais de 2,5 gols e 50% chance de empate/vitória de ambos os times.\n* Como x AC Milan (Serie A) - 30% chance de mais de 2,5 gols e 50% chance de empate/vitória de ambos os times.\n\n**Value Bets**\n\n* FC Augsburg x Union Berlin (Bundesliga) - Vitória de FC Augsburg com odd de 2,75 e probabilidade calculada de 46,53%.\n* Como x AC Milan (Serie A) - Vitória de Como com odd de 2,9 e probabilidade calculada de 43,33%.\n* Hellas Verona x Bologna (Serie A) - Vitória de Bologna com odd de 2,2 e probabilidade calculada de 39,53%.\n* Hellas Verona x Bologna (Serie A) - Vitória de Hellas Verona com odd de 3,5 e probabilidade calculada de 32,13%.\n* Como x AC Milan (Serie A) - Empate com odd de 3,2 e probabilidade calculada de 30%.\n* FC Augsburg x Union Berlin (Bundesliga) - Empate com odd de 3 e probabilidade calculada de 28,8%.\n* Como x AC Milan (Serie A) - Vitória de AC Milan com odd de 2,5 e probabilidade calculada de 28,33%.\n* Hellas Verona x Bologna (Serie A) - Empate com odd de 3,1 e probabilidade calculada de 25,8%.\n\nLembre-se de que essas são apenas recomendações e que é importante fazer suas próprias pesquisas antes de apostar. Boa sorte!",
    date: "2026-01-15",
    category: "Diário",
  },
  {
